...
let mainmenu=document.getElementsByTagName(`div`)[0];
...
const loadScript=(src)=>{
    return new Promise((resolve,reject)=>{
        ...
        script.onload=()=>{resolve(AOS.init({duration: 1000,offset:50,}))}
        script.onerror=()=>{reject(`Script is not loaded`)}
    })
}
button1.addEventListener(`click`,()=>{loadScript("https://unpkg.com/aos@next/dist/aos.js");mainmenu.style.display=(`none`);document.body.style.overflowY=(`auto`)})
