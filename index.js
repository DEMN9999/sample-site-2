...
window.addEventListener(`scroll`,function(){htmlBar.classList.toggle((`barswidth1`),window.scrollY>1078);cssBar.classList.toggle((`barswidth1`),window.scrollY>1138);jsBar.classList.toggle((`barswidth1`),window.scrollY>1200);});document.html.style.overflowX=(`hidden`)
// const hoverOnCards=()=>{let sec =document.querySelector(`section`)
//     let cards=sec.lastElementChild
//     let card1=cards.firstElementChild;
